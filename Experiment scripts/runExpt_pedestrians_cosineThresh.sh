...
python run_mot16_benchmark.py --eval_dir_dpm  "./Results/Pedestrian Tracking/EVAL_DPM/trackOutput-0.3cosineThresh/" \
							   --eval_dir_ssd "./Results/Pedestrian Tracking/EVAL_SSD/trackOutput-0.3cosineThresh/" \
						   --output_path "./Results/Pedestrian Tracking/benchmark_03cosineThresh.txt"
